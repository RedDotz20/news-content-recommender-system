...
export default function Home() {
  return (
    ...
    <div className="min-h-screen">
      ...
      <section className="h-screen flex flex-col justify-center items-center px-4 py-3 sm:px-6 sm:py-4 md:px-8 md:py-5 relative overflow-hidden">
        <DotPattern
          className={cn(
            "absolute inset-0 [mask-image:radial-gradient(500px_circle_at_center,white,transparent)]"
          )}
        />
        <div className="flex flex-col gap-4 md:items-center relative z-10 max-w-4xl mx-auto xs:px-6 md:text-center">
          <AnimatedGradientText className="text-xs md:text-sm">
            🎉 Where every article expands your horizon
          </AnimatedGradientText>
          <h1 className="text-3xl xs:text-5xl sm:text-6xl md:text-6xl lg:text-6xl font-bold tracking-tight">
            Welcome to
            <br />
            <span className="text-blue-400">ArticleHorizon</span>
          </h1>

          <p className="text-sm xs:text-lg sm:text-lg md:text-lg max-w-2xl mx-auto">
      ...
      <section className="flex flex-col justify-center md:items-center py-12 px-4 sm:px-6 md:px-8 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-6xl mx-auto">

          <h2 className="text-4xl xs:text-5xl sm:text-4xl md:text-4xl font-bold md:text-center mb-8">
            Our Core Features
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">

            <Card className="transform transition-transform duration-500 md:hover:translate-y-[-4px] md:hover:scale-105">
              <CardHeader>
                <CardTitle className="text-md xs:text-2xl sm:text-lg md:text-xl lg:text-2xl">
                  Responsive Design
                </CardTitle>
                <CardDescription className="xs:text-lg">
                  Stay connected on-the-go! ArticleHorizon adapts seamlessly to
            ...
            <Card className="transform transition-transform duration-500 md:hover:translate-y-[-4px] md:hover:scale-105">
              <CardHeader>
                ...
                <CardDescription className="xs:text-lg">
                  ...
                  interests and stay informed across various fields.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section className="py-12 px-6 sm:px-6 md:px-8 bg-gradient-to-b from-white to-gray-300 dark:from-gray-900 dark:to-gray-700">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="flex-1 max-w-xl">
              <h1 className="text-3xl xs:text-5xl sm:text-4xl ~sm:text-4xl font-bold mb-6">
              ...
              <ul className="space-y-2">
                <li className="flex items-center">
                  <MobileIcon className="mr-2 h-5 w-5 text-cyan-400" />
              ...
              <div className="mt-6">
                <Link href="/home">
                  <Button className="rounded-xl text-gray-900 text-md p-6 hover:bg-gray-900 hover:text-white duration-200">
                      Start Exploring <PaperPlaneIcon className="ml-2" />
                  </Button>
                </Link>
              </div>
            ...
            <div className="flex-1 w-full max-w-md">
              <Card className="w-full h-full bg-gray-900 dark:bg-gray-200 overflow-hidden shadow-xl shadow-gray-900">
                <CardHeader className="p-6">
                  <CardTitle className="text-2xl font-bold mb-4 text-white dark:text-gray-900">
