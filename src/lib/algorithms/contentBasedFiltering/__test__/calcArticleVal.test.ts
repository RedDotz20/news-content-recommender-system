...
// 		expect(() => calculateArticleValues(relevantPreferences, distributedArticles, distributedCategories))
// 			.toThrow('Top preferences must not be empty.');
// 	});

// 	it('should not throw an error when relevantPreferences is not empty', () => {
// 		const relevantPreferences: CategorialPreferenceType[] = [{ category: 'news', frequency: 5 }];
// 		const distributedArticles: GroupDistributionType = {
// 			firstGroupVal: 1,
// 			secondGroupVal: 1,
// 			thirdGroupVal: 1,
