...
//         expect(() => insertionSort([])).toThrow('Invalid input: preferences must be a non-empty array.');
//     });

//     test('should throw an error for non-array input', () => {
//         expect(() => insertionSort(null)).toThrow('Invalid input: preferences must be a non-empty array.');
//         expect(() => insertionSort(undefined)).toThrow('Invalid input: preferences must be a non-empty array.');
//         expect(() => insertionSort('string' as any)).toThrow('Invalid input: preferences must be a non-empty array.');
//     });
