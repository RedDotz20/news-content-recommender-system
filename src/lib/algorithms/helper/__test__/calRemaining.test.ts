...
//         expect(totalAllocated).toBe(baseValue);
...
//     it('should handle group with existing articles values', () => {
//         const baseValue = 15;
//         const currentGroup: Partial<CategorialPrefWithArticlesType>[] = [{ articles: 5 }, { articles: 3 }];
//         const result = calRemaining(baseValue, currentGroup);

//         const totalAllocated = result.reduce((acc, item) => acc + (item.articles || 0), 0);
//         expect(totalAllocated).toBe(baseValue + 8);
...
//         const baseValue = -5;
//         const currentGroup: Partial<CategorialPrefWithArticlesType>[] = [{}, {}, {}];
//         expect(() => calRemaining(baseValue, currentGroup)).toThrowError();
//     });
// });