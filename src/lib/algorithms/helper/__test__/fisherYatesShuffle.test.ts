...
import { isEqual } from 'lodash'; // Import lodash for deep equality check
	...
	const mockArticles: ArticleTypes[] = [
		{
			...
			short_description:
				'Exploring the top technological advancements for the year 2024.',
		},
		{
			id: '2',
			...
			short_description:
				'How AI and data are transforming healthcare systems globally.',
		},
		{
			id: '3',
