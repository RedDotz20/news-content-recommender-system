...
//         expect(shuffled).not.toEqual(mockArticles);
//     });

//     test('should return a new array that contains the same elements', () => {
//         const shuffled = fisherYatesShuffle(mockArticles);
//         expect(shuffled.sort()).toEqual(mockArticles.sort());
//     });

//     test('should throw an error if the input is not an array', () => {
//         expect(() => fisherYatesShuffle(null as any)).toThrow('Input must be a non-empty array of NewsItem objects.');
//         expect(() => fisherYatesShuffle({} as any)).toThrow('Input must be a non-empty array of NewsItem objects.');
//     });

//     test('should throw an error if the input is an empty array', () => {
//         expect(() => fisherYatesShuffle([])).toThrow('Input must be a non-empty array of NewsItem objects.');
//     });
...
//         expect(shuffled).toEqual(singleArticle);
//     });
// });